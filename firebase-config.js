...
import { getFirestore, collection, addDoc, getDocs, getDoc, doc, updateDoc, deleteDoc, query, where } 
...
export { db, collection, addDoc, getDocs, getDoc, doc, updateDoc, deleteDoc, query, where };
